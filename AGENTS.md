...
The build specs in [`docs/spec/`](docs/spec/) are the source of truth for _what_ to build. Before writing code for a feature, READ the relevant spec and implement it exactly:
...
- The dependency allowlist is **closed** — anything outside it needs an approved PR comment from Claude _before_ install.
